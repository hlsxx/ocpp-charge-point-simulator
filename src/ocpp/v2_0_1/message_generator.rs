...
impl MessageGeneratorTrait for MessageGenerator {
  ...
  fn authorize(&self) -> Value {
    FrameBuilder::build_call(OcppAction::Authorize, AuthorizeRequest {
  ...
  fn start_transaction(&self) -> Value {
    FrameBuilder::build_call(OcppAction::TransactionEvent, TransactionEventRequest {
  ...
  fn data_transfer(&self) -> Value {
    FrameBuilder::build_call(OcppAction::DataTransfer, DataTransferRequest {
